...
public class ImpCrimeAnalysisService {
	...
	public boolean createIncident(Incident i) throws VictimIdNotFoundException,SuspectIdNotFoundException,OfficerIdNotFoundException,InvalidDateException
	{
		try
		{
			...
			stat.setDouble(4, i.getLatitude());
			stat.setDouble(5, i.getLongitude());
			stat.setString(6, i.getDescription());
			stat.setString(7, i.getStatus());
			stat.setInt(8, i.getVictimId());
			stat.setInt(9, i.getSuspectId());
			stat.setInt(10, i.getOfficerId());
	...
	public Report generateIncidentReport(int incidentId,int reportId,String reportStatus) throws IncidentNumberNotFoundException
	{
	...
	private Incident getIncident(ResultSet set) throws SQLException
	{
		...
		incident.setLatitude(set.getDouble("Latitude"));
		incident.setLongitude(set.getDouble("Longitude"));
