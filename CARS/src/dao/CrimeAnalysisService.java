...
public class CrimeAnalysisService {
	...
	public void createIncident() 
	{
		...
		Incident incident=new Incident(incidentId,incidentType,incidentDate,latitude,longitude,description,status,victimId,suspectId,officerId);
		boolean flag=false;
		try 
		{
	...
	public void generateIncidentReport()
	{
        ...
        String reportStatus = sc.next(); 
		System.out.println(reportStatus);
		try 
		{
			Report report = impcrime.generateIncidentReport(incidentId, reportid, reportStatus);
			if(report!=null)
			{
