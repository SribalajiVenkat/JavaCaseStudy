...
public class CrimeSystemUnitTest {
	...
	void testCreateIncident() {
		Incident incident = new Incident(
			108, "Robbery", "2021-04-07",
			19.0760, 72.8777,  // latitude and longitude for Mumbai
			"bank robbery", "Open",
			201, 11, 21
		);
...
void testCreateIncidentValues() {
    Incident incident = new Incident(
        109, "Assault", "2019-09-13",
        18.5204, 73.8567,  // e.g., Pune coordinates
        "physical assault", "Open",
        202, 12, 17
    );
    try {
